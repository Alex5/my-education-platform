        ...
        return (
            <Grid.Container gap={2} justify="center">
                <Grid xs={24} direction={"column"}>
                    <Note type="success">
                        My Education Platform не хранит ваше имя, email и фотографию. Вся информация
                        загружается с серверов Google во время входа, и хранится у вас на вашем компьютере.
                    </Note>
                    <Spacer/>
                    <Fieldset style={{width: '100%'}}>
                        ...
                        <Fieldset.Subtitle>
                            ...
                            <Radio.Group value={author ? EStatus.author : EStatus.user}
                        ...
                        <Fieldset.Footer>
                            ...
                            <Button loading={load} onClick={handleSaveStatus} auto scale={1 / 3}
                                    children={'Сохранить'}/>
                        </Fieldset.Footer>
                    </Fieldset>
                    <Spacer/>
